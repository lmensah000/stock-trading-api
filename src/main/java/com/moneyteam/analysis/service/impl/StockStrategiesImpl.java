package com.moneyteam.analysis.service.impl;

import com.moneyteam.user.model.User;
import com.moneyteam.analysis.model.TechnicalAnalysis;
import com.moneyteam.analysis.model.FundamentalAnalysis;
import com.moneyteam.analysis.model.RiskManagement;
import com.moneyteam.marketdata.model.Stock;
import com.moneyteam.marketdata.model.Crypto;
...
//    }
    ...
    public static boolean shouldBuy(Stock stock) {
    ...
    public static boolean shouldSell(Stock stock) {
        // Replace this with your actual trading strategy logic
        double stockPrice = stock.getLast();
